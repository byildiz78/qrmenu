      ...
      <Link href={`/product/${product.id}`}>
        <div className="relative group/name">
          ...
          <div className="relative bg-gradient-to-r from-background/95 to-background/90 backdrop-blur-md border border-primary/10 rounded-xl p-4 group-hover/name:border-primary/30 transition-all">
            <h2 className="text-2xl font-bold bg-gradient-to-br from-foreground via-foreground/90 to-foreground/80 bg-clip-text text-transparent group-hover/name:from-primary group-hover/name:to-primary/80 transition-all duration-300">
              {product.name}
            </h2>
          </div>
        </div>
